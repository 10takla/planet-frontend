...
const Form: FC<IForm> = ({form}) => {
    ...
    const handleForm = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        validationForm() && fetchAuthUser(dispatch, form.class,
            ...
            .then((data: any) => {
                dispatch(appStateSlice.actions.setAuthState({isAuth: true, token: data.token}))
            })
            .catch(error => {
    ...
    return (
        <form ref={formRef} onSubmit={handleForm}
            ...
            {form.foot && <img className='close' src={process.env.PUBLIC_URL + "/assets/images/close.svg"}
