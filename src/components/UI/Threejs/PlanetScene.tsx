import React, {CSSProperties, FC, HTMLProps, MouseEvent, useCallback, useRef, useState, WheelEvent} from 'react';
import Camera from "../../Store/Threejs/components/Camera";
import OrbitControl from "../../Store/Threejs/components/OrbitControl";
import "../../../styles/ui/threejs/scene.scss"
...
import CombinePlanet from "../../Store/Threejs/Planet/CombinePlanet";
...
const PlanetScene: FC<IPlanetScene> = ({fields, planet, ...props}) => {
